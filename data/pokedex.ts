export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	rotom: {
		...
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Smog"],
		formeOrder: ["Rotom", "Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Smog"],
	},
	rotomheat: {
		num: 479,
		name: "Rotom-Heat",
